...
1. ✅ **alternateName**: 'Slayerbound' - 添加组织的备用名称
2. ✅ **description**: 'Complete Slayerbound Wiki resource hub for codes, tier lists, and guides' - 添加组织描述
...
```javascript
{
  ...
  url: siteUrl,
  description: 'Complete Slayerbound Wiki resource hub for codes, tier lists, and guides',
  logo: {
    '@type': 'ImageObject',
    url: `${siteUrl}/images/hero.webp`,
    width: 768,
