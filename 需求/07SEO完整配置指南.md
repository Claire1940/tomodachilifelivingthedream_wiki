...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.bizarrelineage.wiki'
...
```json
{
  "seo": {
    "home": {
      "title": "Bizarre Lineage Wiki - Codes, Stands & Tier List",
      "description": "Bizarre Lineage Wiki with codes, stands...",
      "keywords": "Bizarre Lineage, Roblox, codes, stands, tier list...",
      "ogTitle": "Bizarre Lineage Wiki - Codes, Stands & Tier List",
      "ogDescription": "Complete Bizarre Lineage resource hub!...",
      "twitterTitle": "Bizarre Lineage Wiki - Codes, Stands & Tier List",
      "twitterDescription": "Complete Bizarre Lineage resource hub!..."
    }
  }
}
```
...
```json
{
  "pages": {
    "about": {
      "metaTitle": "About - Bizarre Lineage Wiki",
      "metaDescription": "Learn about Bizarre Lineage Wiki..."
    },
    "codes": {
      "metaTitle": "Codes - Bizarre Lineage Wiki",
      "metaDescription": "All active codes for Bizarre Lineage..."
    }
  }
}
```
...
```html
<!-- 基础 Meta -->
<title>Bizarre Lineage Wiki - Codes, Stands & Tier List</title>
